<template><div><h1 id="infinitescroll-无限滚动" tabindex="-1"><a class="header-anchor" href="#infinitescroll-无限滚动" aria-hidden="true">#</a> InfiniteScroll 无限滚动</h1>
<p>滚动至底部时，加载更多数据。</p>
<h3 id="基础用法" tabindex="-1"><a class="header-anchor" href="#基础用法" aria-hidden="true">#</a> 基础用法</h3>
<p>在要实现滚动加载的列表上上添加<code v-pre>v-infinite-scroll</code>，并赋值相应的加载方法，可实现滚动到底部时自动执行加载方法。
:::demo</p>
...
<h3 id="禁用加载" tabindex="-1"><a class="header-anchor" href="#禁用加载" aria-hidden="true">#</a> 禁用加载</h3>
<p>:::demo</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
