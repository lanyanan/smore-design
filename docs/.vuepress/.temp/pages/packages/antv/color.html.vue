<template><div><h1 id="color-色彩" tabindex="-1"><a class="header-anchor" href="#color-色彩" aria-hidden="true">#</a> Color 色彩</h1>
<p>Element 为了避免视觉传达差异，使用一套特定的调色板来规定颜色，为你所搭建的产品提供一致的外观视觉感受。</p>
<h3 id="主色" tabindex="-1"><a class="header-anchor" href="#主色" aria-hidden="true">#</a> 主色</h3>
...
:::
<h3 id="辅助色" tabindex="-1"><a class="header-anchor" href="#辅助色" aria-hidden="true">#</a> 辅助色</h3>
