<template><div><h1 id="timepicker时间选择器" tabindex="-1"><a class="header-anchor" href="#timepicker时间选择器" aria-hidden="true">#</a> TimePicker时间选择器</h1>
<h3 id="固定时间点" tabindex="-1"><a class="header-anchor" href="#固定时间点" aria-hidden="true">#</a> 固定时间点</h3>
<p>提供几个固定的时间点供用户选择</p>
<p>:::demo 使用 dl-time-picker 标签，分别通过<code v-pre>start</code>、<code v-pre>end</code>和<code v-pre>step</code>指定可选的起始时间、结束时间和步长</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dl-time-picker</span>
...
<h3 id="任意时间点" tabindex="-1"><a class="header-anchor" href="#任意时间点" aria-hidden="true">#</a> 任意时间点</h3>
<p>可以选择任意时间</p>
<p>:::demo 使用 dl-time-picker 标签，通过<code v-pre>selectableRange</code>限制可选时间范围。提供了两种交互方式：默认情况下通过鼠标滚轮进行选择，打开<code v-pre>arrow-control</code>属性则通过界面上的箭头进行选择。</p>
...
<h3 id="固定时间范围" tabindex="-1"><a class="header-anchor" href="#固定时间范围" aria-hidden="true">#</a> 固定时间范围</h3>
<p>若先选择开始时间，则结束时间内备选项的状态会随之改变
dl-time-picker
:::demo</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dl-time-picker</span>
...
<h3 id="任意时间范围" tabindex="-1"><a class="header-anchor" href="#任意时间范围" aria-hidden="true">#</a> 任意时间范围</h3>
<p>可选择任意的时间范围</p>
<p>:::demo 添加<code v-pre>is-range</code>属性即可选择时间范围，同样支持<code v-pre>arrow-control</code>属性。</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dl-time-picker</span>
...
<tr>
<td>is-fixed-time</td>
<td>是否为固定时间，true(TimeSelect) / false(TimePicker)</td>
<td>boolean</td>
<td>—</td>
<td>false</td>
</tr>
<tr>
<td>is-range</td>
<td>是否为时间范围选择，仅对<code v-pre>&lt;dl-time-picker&gt;</code>有效</td>
<td>boolean</td>
<td>—</td>
<td>false</td>
</tr>
<tr>
<td>arrow-control</td>
<td>是否使用箭头进行时间选择，仅对<code v-pre>&lt;dl-time-picker&gt;</code>有效</td>
<td>boolean</td>
<td>—</td>
<td>false</td>
</tr>
...
<td>Date(TimePicker) / string(TimeSelect)</td>
<td>可被<code v-pre>new Date()</code>解析(TimePicker) / 可选值(TimeSelect)</td>
<td>—</td>
</tr>
<tr>
<td>name</td>
...
<h3 id="time-select-options" tabindex="-1"><a class="header-anchor" href="#time-select-options" aria-hidden="true">#</a> Time Select Options</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<h3 id="time-picker-options" tabindex="-1"><a class="header-anchor" href="#time-picker-options" aria-hidden="true">#</a> Time Picker Options</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>可选时间段，例如<code v-pre>'18:30:00 - 20:30:00'</code>或者传入数组<code v-pre>['09:30:00 - 12:00:00', '14:30:00 - 18:30:00']</code></td>
<td>string / array</td>
<td>—</td>
<td>—</td>
</tr>
...
<td>string</td>
<td>小时：<code v-pre>HH</code>，分：<code v-pre>mm</code>，秒：<code v-pre>ss</code>，AM/PM <code v-pre>A</code></td>
<td>'HH:mm:ss'</td>
</tr>
</tbody>
</table>
